...
void LoadTitle(int *game_state, ComponentData* ComponentsArr, RenderData* RenderBuff, Sprite* CacheArr) {
    ...
    if (!(*game_state)) {
        ...
        AddMouseEvent(&ComponentsArr[0], CommonButtonEvents, 0);
        ...
        AddMouseEvent(&ComponentsArr[1], CommonButtonEvents, 0);
...
// void (*nextScene)(int*, ComponentData*, RenderData*, Sprite*)
void LoadingScene() {
